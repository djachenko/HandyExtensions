...
extension SCNNode {
    ...
    class func axesNode(quiverLength: CGFloat, quiverThickness: CGFloat) -> SCNNode {
        ...
        xQuiverNode.position = SCNVector3(x: Float(quiverLength / 2.0), y: 0.0, z: 0.0)
        ...
        yQuiverNode.position = SCNVector3(x: 0.0, y: Float(quiverLength / 2.0), z: 0.0)
        ...
        zQuiverNode.position = SCNVector3(x: 0.0, y: 0.0, z: Float(quiverLength / 2.0))
